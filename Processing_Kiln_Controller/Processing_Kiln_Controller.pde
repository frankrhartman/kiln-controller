...
float ramps[][][] = {
                      { {55, 105, 0}, {180, 1195, 0}, {-500, 980, 60}, {0, 0, 0} },                                  //C6 980 Hold
                      { {55, 105, 0}, {200, 1080, 0}, {85, 1200, 15}, {-275, 1000, 0}, {-70, 760, 0}, {0, 0, 0} },   //Ron Roy
                      { {55, 105, 0}, {180, 1195, 15}, {-500, 1140, 60}, {-500, 1000, 0}, {-50, 750, 0}, {0, 0, 0} },//creepy C6 mattes
                      { {55, 105, 0}, {180, 1195, 15}, {-500, 1140, 60}, {0, 0, 0} },                                //creepy C6 gloss
                      { {55, 105, 0}, {180, 700, 0}, {50, 950, 0}, {180, 1070, 30}, {0, 0, 0} },                     //creepy C04 bisque
